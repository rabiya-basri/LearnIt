...
class Comment{
    ...
    private $con, $sqlData, $usernameLoggedInObj, $videoId;

    public function __construct($con, $input, $usernameLoggedInObj, $videoId){
    ...
    public function create(){  
        ...
        $commentControlsObj = new CommentControls($this->con, $this, $this->usernameLoggedInObj);
    ...
    public function getReplies(){
        ...
        while($row = $query->fetch(PDO::FETCH_ASSOC)){
            $comment = new Comment($this->con, $row, $this->usernameLoggedInObj, $videoId);
