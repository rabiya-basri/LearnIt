...
class SettingsFormProvider {
    public function createUserDetailsForm($firstName, $lastName, $email) {
        ...
        return"<form action='setting.php' method='POST' enctype='multipart/form-data'>
        <span class='title'>Users Details</span>
        $firstNameInput
        $lastNameInput
        $emailInput
        $saveButton
    ...
    private function createFirstNameInput($value){
      ...
      <input class='form-control form-control-lg' type='text' placeholder='First Name' name='firstName' value='$value' required>
      </div>
      ";    
    }
    private function createLastNameInput($value){
        if($value == null) $value = "";
        return "<div class='form-group'>
        <input class='form-control form-control-lg' type='text' placeholder='Last Name' name='lastName' value='$value' required>
        </div>
        ";   
      }
      private function createEmailInput($value){
        if($value == null) $value = "";
        return "<div class='form-group'>
        <input class='form-control form-control-lg' type='email' placeholder='Email' name='email' value='$value' required>
        </div>
        ";   
      }
    ...
    return "<div class='form-group'>
    <input class='form-control form-control-lg' type='password' placeholder='$placeholder' name='$name' required>
    </div>
    ";    
  }
}
