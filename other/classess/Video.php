...
class Video{
    ...
    private $con,$sqlData, $usernameLoggedInObj;

    public function __construct($con, $input, $usernameLoggedInObj){
        $this->con = $con;
   ...
   public function like() {
    ...
    public function getComments(){
        ...
        while($row = $query->fetch(PDO::FETCH_ASSOC)){
            $comment = new Comment($this->con, $row, $this->usernameLoggedInObj, $id);
